...
export const PROGRAMS: Program[] = [
  {
    ...
    steps: [
      { title: 'Apply', desc: 'Tell us about your background, search thesis, timeline, and what you are looking for in a partner.' },
  ...
  },
  {
    ...
    interestOptions: ['I am a searcher looking for investors', 'I am an investor looking for searchers to back', 'Independent sponsor seeking deal-by-deal capital', 'Investor seeking co-investment opportunities', 'Follow-on capital for a specific acquisition'],
    ...
    requiresSectors: true,
    steps: [
      { title: 'Apply', desc: 'Tell us whether you are a searcher or investor, your thesis, preferred sectors, deal size, and geography.' },
  ...
  },
  {
    ...
    interestOptions: ['I am a searcher looking for advisors', 'I am an advisor looking to support searchers', 'Board member opportunity', 'Deal sourcing advisor', 'Due diligence advisor', 'Post-acquisition advisor', 'Industry-specific expertise'],
  ...
  },
  {
    ...
    interestOptions: ['I am an operator looking for a company to run', 'I am a searcher looking for an operator', 'I am an investor looking for operating talent', 'Operating partner for a portfolio company', 'Industry-specific operator', 'Interim management'],
    ...
    requiresSectors: true,
    steps: [
      { title: 'Apply', desc: 'Tell us about your operational experience, preferred industries, and what kind of opportunity you are looking for (or offering).' },
  ...
  },
  {
    ...
    interestOptions: ['I am looking for a mentor', 'I am willing to mentor', 'Career guidance in ETA', 'Search fund formation advice', 'Deal sourcing mentorship', 'Post-acquisition mentorship'],
  ...
  },
  {
    ...
    requiresSectors: true,
    steps: [
      { title: 'Apply', desc: 'Tell us about your investment thesis, preferred deal sizes, sectors, and what kind of co-investment partner you are seeking.' },
  ...
  },
  {
    ...
    requiresSectors: true,
    steps: [
      { title: 'Submit', desc: 'Provide details about your company, the role, and what you are looking for in a candidate.' },
